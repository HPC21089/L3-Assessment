...
if __name__ == "__main__":
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYUP:#Setting the switch for changing game states + resetting variables
            ...
            if game_state == "paused":#Selection arrow movement
            ...
            if game_state == "active": #Combo input tracking, Executing a combo, Clearing combo list, Limiting no. of recorded inputs
                if not cooldown:
        ...
        if not cooldown: #Player Pointing Animation
        ...
        if game_state == "active": #Blit game ui
            ...
            #Restricts arrow to only on screen options
